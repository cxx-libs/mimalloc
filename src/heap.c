...
[[nodiscard]] mi_heap_t* mi_heap_new_ex(int heap_tag, bool allow_destroy, mi_arena_id_t arena_id) {
...
[[nodiscard]] mi_heap_t* mi_heap_new_in_arena(mi_arena_id_t arena_id) {
